...
print(f"Target Class: {t};  epsilon: {epsReal}") # Added by LHY
...
# print("Original Predicted Class Probabilities: ", N(x))
# print("Adversarial Target Class: ", torch.tensor([t], dtype=torch.long))
loss.backward()
...
adv_x = torch.clamp(adv_x, 0.0, 1.0) # ensure adv_x is in a valid range
